...
class Answers(models.Model):
    question_ID = models.ForeignKey(QuestionModel, verbose_name="question ID", on_delete=models.CASCADE)
...
class Answer(models.Model):
    ...
    option_ID = models.ForeignKey(OptionModel, verbose_name="option ID", on_delete=models.CASCADE)
