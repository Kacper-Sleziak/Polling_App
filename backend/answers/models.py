...
class AnswerDetails(models.Model):
    ...
    text_answer = models.CharField(verbose_name="text_answer", max_length=2000, blank=True, null=True)
    option_id = models.ForeignKey(
        Option, verbose_name="option id", on_delete=models.CASCADE, blank=True, null=True)
