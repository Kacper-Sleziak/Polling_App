...
class Trigger(models.Model):
    ...
    def clean(self):
        ...
        # For example question1 is triggeringg question2 and question2 is triggering question2
        queryset = Trigger.objects.filter(triggering_question=self.triggered_question)
        if queryset.exists():
            raise ValidationError(
